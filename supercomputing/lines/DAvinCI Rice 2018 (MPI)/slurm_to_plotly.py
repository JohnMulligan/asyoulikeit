...
#THIS SCRIPT
##TAKES A SLURM OUTPUT FILE GENERATED BY SHAKESPEARE_MPI_BLOCKING
##AND TRANSFORMS IT INTO AN INTERACTIVE GRAPH IN PLOTLY

##USAGE IS LIKE python slurm_to_plotly.py -s 2821421
